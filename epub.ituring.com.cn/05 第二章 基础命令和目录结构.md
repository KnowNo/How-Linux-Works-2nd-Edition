...
<table>
  <tbody>
<tr> <td> ps x </td> <td> Show all of your running processes. </td> </tr>
<tr> <td> ps ax </td> <td> Show all processes on the system, not just the ones you own. </td> </tr>
<tr> <td> ps u </td> <td> Include more detailed information on processes. </td> </tr>
<tr> <td> ps w </td> <td> Show full command names, not just what fits on one line. </td> </tr>
  </tbody>
</table>
...
<table>
<tbody>
￼<tr> <td> r </td> <td> Means that the file is readable. </td> </tr>
￼<tr> <td> w </td> <td> Means that the file is writable. </td> </tr>
￼<tr> <td> x </td> <td> Means that the file is executable (you can run it as a program).</td> </tr>
￼<tr> <td> - </td> <td> Means nothing. </td> </tr>
</tbody>
</table>
